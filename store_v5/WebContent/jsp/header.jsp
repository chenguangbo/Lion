				...
				<div class="col-md-3" style="padding-top:20px">
					<ol class="list-inline">
					  <c:if test="${not empty loginUser}">  
						...
						<li><a href="${pageContext.request.contextPath}/OrderServlet?method=findOrderByUid&pageNumber=1">我的订单</a></li>
					  </c:if>
...
$(function(){
	$.post("${pageContext.request.contextPath}/CategoryServlet",{"method":"findAllCats"},function(dt){
		...
		for(var i=0;i<dt.length;i++){
			var li="<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findProductsByCidWithPage&pageNumber=1&cid="+dt[i].cid+"'>"+dt[i].cname+"</a></li>";
			$("#myUL").append(li);
		}
