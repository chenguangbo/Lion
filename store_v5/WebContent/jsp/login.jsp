...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet?method=userLogin" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
   <%--    <img src="${pageContext.request.contextPath}/jsp/images.jsp"/> --%>
      <img alt="图片验证码，点击刷新"
			src="${pageContext.request.contextPath}/jsp/images.jsp" style="cursor: pointer;width:50;height:30 vertical-align: middle"
			onclick="this.src='${pageContext.request.contextPath}/jsp/images.jsp?rand='+Math.random()" />
    </div>
